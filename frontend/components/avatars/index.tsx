 ...
 *
 *   AI Manager     male,   silver tie, calm leader
 *   AI Architect   male,   builder, light bandana
 *   AI Secure      male,   guardian, beard + shield collar
 ...
 *
 * Palette is monochrome — every fill is white / black / a shade of grey.
 * Skin tones stay as neutral tans so faces still read as human.
 */
...
const ACCENT = "#e5e5e5";       // silver — replaces every coloured accent
const SKIN_LIGHT = "#d9c2a8";   // muted tan
const SKIN_MED = "#bda285";     // darker muted tan
const HAIR_DARK = "#141414";
const HAIR_MID = "#2e2e2e";
const HAIR_LIGHT = "#5a5a5a";
...
export const SearcherAvatar = (props: AvatarProps) => (
  <Frame bg="#1c1c1c" {...props}>
    <path d="M26 44 Q50 22 74 44 L74 64 Q70 72 64 70 L36 70 Q30 72 26 64 Z" fill={HAIR_MID} />
    <path d="M72 56 Q82 68 78 84 L74 82 Q76 70 70 62 Z" fill={HAIR_MID} />
...
export const MetodistAvatar = (props: AvatarProps) => (
  <Frame bg="#181818" {...props}>
    <circle cx="50" cy="30" r="10" fill={HAIR_LIGHT} />
